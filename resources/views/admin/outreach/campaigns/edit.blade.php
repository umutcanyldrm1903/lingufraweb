...
@section('title')
    <title>{{ __('Edit Outreach Campaign') }}</title>
@endsection
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>{{ __('Edit Outreach Campaign') }}</h1>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.outreach-campaigns.update', $outreachCampaign) }}" method="POST">
                            ...
                            <a href="{{ route('admin.outreach-campaigns.show', $outreachCampaign) }}" class="btn btn-light border">{{ __('Back') }}</a>
                        </form>
                    </div>
                </div>
            </div>
