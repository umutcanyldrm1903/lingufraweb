...
if (!function_exists('adminSearchRouteList')) {
    function adminSearchRouteList(): object {
        $route_list = [
            ...
            (object) ['name' => 'Outreach Bot', 'route' => route('admin.outreach-campaigns.index'), 'permission' => ''],
            (object) ['name' => 'Outreach Sağlayıcıları', 'route' => route('admin.crediential-setting'), 'permission' => 'setting.view', 'tab' => 'outreach_provider_tab'],
