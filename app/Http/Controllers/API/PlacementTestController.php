...
{
    public function questions(Request $request, PlacementTestEngine $engine): JsonResponse
    {
    ...
    public function submit(Request $request, PlacementTestEngine $engine): JsonResponse
    {
