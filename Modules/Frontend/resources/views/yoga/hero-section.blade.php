                                ...
                                <form
                                    ...
                                    <div class="row">
                                        @if ($code == $languages->first()->code)
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Image') }} <br><code>({{ __('Recommended') }}: 575X750 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background') }} <br><code>({{ __('Recommended') }}: 740X650 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background Two') }} <br><code>({{ __('Recommended') }}: 390X580 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Hero Background') }} <br><code>({{ __('Recommended') }}: 1920X940 PX)</code></label>
