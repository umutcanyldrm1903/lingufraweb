                                ...
                                <form
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($code == $languages->first()->code)
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Image') }} <br><code>({{ __('Recommended') }}: 260X570 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background Two') }}  <br><code>({{ __('Recommended') }}: 590X550 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Hero Background') }} <br><code>({{ __('Recommended') }}: 1920X620 PX)</code></label>
