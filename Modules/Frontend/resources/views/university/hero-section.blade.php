                                ...
                                <form action="{{ route('admin.hero-section.update', ['code' => $code]) }}" method="post"
                                    ...
                                    <div class="row">
                                        @if ($code == $languages->first()->code)
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Image') }} <br><code>({{ __('Recommended') }}: 690X710 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Banner Background') }} <br><code>({{ __('Recommended') }}: 690X541 PX)</code></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>{{ __('Hero Background') }} <br><code>({{ __('Recommended') }}: 1920X770 PX)</code></label>
