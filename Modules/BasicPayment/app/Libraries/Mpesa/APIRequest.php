...
namespace Modules\BasicPayment\app\Libraries\Mpesa;
use Exception;
...
class APIRequest {
    ...
    function create_bearer_token(): string {
        $publicKeyPem = "-----BEGIN PUBLIC KEY-----\n" .
             chunk_split($this->context->get_public_key(), 64, "\n") .
             "-----END PUBLIC KEY-----\n";

        $apiKey = $this->context->get_api_key();
        $encrypted = '';

        $success = openssl_public_encrypt($apiKey, $encrypted, $publicKeyPem, OPENSSL_PKCS1_PADDING);
