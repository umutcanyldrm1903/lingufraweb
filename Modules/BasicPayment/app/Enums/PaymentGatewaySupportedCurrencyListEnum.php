...
enum PaymentGatewaySupportedCurrencyListEnum {
    ...
    public static function getIyzicoSupportedCurrencies(): array {
        return ['TRY'];
    }

    public static function isIyzicoSupportedCurrencies($code): bool {
        return in_array(Str::upper($code), self::getIyzicoSupportedCurrencies());
    }
}
