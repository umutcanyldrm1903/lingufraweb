...
class GlobalSettingInfoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $setting_data = [
            ...
            'outreach_openai_api_key' => '',
            'outreach_openai_model' => 'gpt-5-mini',
            'outreach_openai_base_url' => 'https://api.openai.com/v1',
            'outreach_openai_timeout' => '60',
            'outreach_lusha_api_key' => '',
            'outreach_lusha_api_key_prefix' => '',
            'outreach_lusha_send_authorization_header' => '0',
            'outreach_lusha_base_url' => 'https://api.lusha.com',
            'outreach_lusha_search_path' => '/prospecting/contact/search',
            'outreach_lusha_enrich_path' => '/prospecting/contact/enrich',
            'outreach_lusha_timeout' => '45',
            'outreach_imap_host' => '',
